...
return [
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa Cultural de Redenção (PA)"),
    "text:home-register.description1" => i::__("Contribua com a plataforma livre e interativa de mapeamento do cenário cultural e instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas culturais promovidas pela Secretaria Municipal de Cultura e Lazer de Redenção."),
    'text:home-developers.description' => 'Além disso, Mapa cultural do Pará é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
